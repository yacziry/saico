                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Recuperar contrase&ntilde;a</li>
                        </ol>                                       
                    </nav>
                            ...
                            <div class="row align-items-center justify-content-between">
                                ...
                                <h3>Recuperar contrase&ntilde;a</h3>
                                    ...
                                    <div class="contact-form-area mb-100">
                                        <form id="validarEmail" action="validarRecuperarPass.php" method="post" role="form" style="display: block;">	
									        <div class="form-group">
									            <p class="p">Escribe el E-mail que tenemos registrado:</p>
										        <input type="email"  id="email" class="form-control" placeholder="Correo" name="deEmail" pattern="[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*@[a-zA-Z0-9_]+([.][a-zA-Z0-9_]+)*[.][a-zA-Z]{1,5}" required>
									        </div>
									        <p><output><?php echo @$msg; ?> </output></p>									
									        <p class="active"><?php echo @$msgC; ?></p>
									        <br>
									        <div class="form-group">
										        <div class="row">
											        <div class="col-sm-6 col-sm-offset-3">
												        <input type="submit" class="btn alazea-btn mt-15" value="Recuperar">
											        </div>
										        </div>
                                            </div>									
								        </form>

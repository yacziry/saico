            ...
            <div class="row">
                <div class="col-12">
					...
					<?php
                        ...
                        $forReportes = $c->buscarClave($clave);
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" name="f">
                        <div class="form-row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Actualizar" class="btn alazea-btn mt-15" onclick=this.form.action="validarActualizarClaveCaracterizacion.php">          
                                </div>
                            </div>
                        </div>
                        <?php

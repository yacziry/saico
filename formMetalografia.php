...
<body>
    ...
    <div class="breadcrumb-area">
        ...
        <div class="top-breadcrumb-area bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(img/bg-img/4.jpg);">
            <h2>REPORTE DE ANÁLISIS METALOGRÁFICO</h2>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-12">
                        ...
                        <div class="form-row">
                            ...
                            <div class="table-responsive" align="center">
                                <table class="table table-bordered" border="1">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><input class="form-control" type="text" maxlength="4" name="numLija1" value="240" size="5"  required></td>
                                ...
                                <div class="alert alert-warning alert-dismissable">
                                    ...
                                    <strong>¡Advertencia!</strong>El peso de la imagen afecta el rendimiento".
                                </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label for="ex3">Nombre de quien elaboró</label>
                                    <input class="form-control" type="text" name="deElabora" placeholder="ING..." required><br>
                                    <input class="form-control" type="text" name="deAprobacion" value="Asesoría e Inspección en Construcción Costa Fuera, S.C" disabled>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label for="ex3">Nombre de quien aprobó</label>
                                    <input class="form-control" type="text" name="deAprueba" placeholder="ING..." required><br>
                                    <input class="form-control" type="text" name="firma2" value="Asesoría e Inspección en Construcción Costa Fuera, S.C" disabled>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Registrar y continuar" class="btn alazea-btn mt-15" onclick=this.form.action="validarMetalografia.php">          
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Finalizar" class="btn alazea-btn mt-15" onclick=this.form.action="validarMetalografiaFinalizar.php">
                                </div>
                            </div>
                            <br>
                        </div>

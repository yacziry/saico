...
<?php
	...
	require 'normasDAO.php';
		...
		$n = new Normas();
		$norma = $n->buscarNormaSelected($row->canorma_norma);
		foreach ($norma as $rowNorma){}
?>
            ...
            <div class="cuerpo">
                <table width="981" border="0">
                    <tr>
                        ...
                        <td width="144"><input type="tetxt" value="<?php echo  $b; ?>" class="sinborde"></td>
		...
		<div class="m_table">
			...
			<table width="981" border="1">
				...
				<tr align="center">
					...
					<td rowspan="2"><label class="texto"><?php echo  $row->clPromedio; ?></td>
				</tr>
				<tr align="center">
			...
			<table width="981" border="1">
				...
				<tr align="center">
					<td><label id="normaValor" class="texto"><?php echo  $row->canorma_norma; ?></td>

<?php
//**************************************************************************
//FORMULARIO PARA MOSTRAR EL REPORTE DE Metalografia
//**************************************************************************
    ...
    <body align="center">
        <div class="encabezado">
            <table width="981" height="80" border="1">
                <tr>
                    ...
                    <td id="centrado" width="200" rowspan="3"onclick="location.href='formBuscarNr.php'"><span><img src="/AICO/img/icon.png" alt="sample"></span></td>
                </tr>
                <tr>
        ...
        <div class="borde">
            ...
            ?>
                <table width="981" border="0">
                    <tr>
                        <td width="110">ACCESORIO:</td>
                        <td width="210"><input type="text" name="deTubEstruc" value="<?php echo  $a ?>" class="sinborde" size="35"></td>
                        <td width="70" align="center">TUBERIA:</td>
                        <td width="144"><input type="text" name="deTubEstruc" value="<?php echo  $b ?>" class="sinborde" size="35"></td>
                        <td width="70">ESTRUCTURAL:</td>
                        <td width="150"><input type="text" name="deTubEstruc" value="<?php echo  $c ?>" class="sinborde"></td>
                    </tr>
                </table>
            </div>
            <br>

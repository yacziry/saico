            ...
            <div class="row">
                <div class="col-12">
					...
					<div align="center">
						...
						<h3>Elegir la tecnica y la palabra a encontrar</h3>
						<br>										
						<form>								
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="text" class="form-control"  name="palabraCl" id="palabraCl" required>
                                </div>
                            </div>
							<!--input type="button" id="submit"class="btn btn-primary mb-2" value="Enviar"-->
						</form>
					</div>				        
				</div>
			</div>

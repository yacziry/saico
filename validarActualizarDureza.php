...
if(isset($_SESSION['tecnico']) && isset($_POST)){
    ...
    if(empty($_POST['clContrato'])){
        ...
        $arrayDureza=array('clContrato'=>$_POST['clContrato'],'deProyecto'=>$_POST['deProyecto'],'clOrdenTrabajo'=>$_POST['clOrdenTrabajo'],
            ...
            'numDureza10'=>$_POST['numDureza10'],'clPromedio'=>$_POST['clPromedio'],'deNormaReferencia'=>$_POST['deNormaReferencia'],'feRegistro'=>$fecha, 'deElabora'=>$_POST['deElabora'],
			'deAprueba'=>$_POST['deAprueba']); 
        session_start();
        ...
        $d = new Dureza();
        $lastId = $d->modificar($reporteS, $arrayDureza);

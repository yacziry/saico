...
<div class="composicion_q"><table width="981" border="1" class="table table-bordered; fixed">
  ...
  <tr>
    ...
    <td width="144"><input type="text" name="mba1" value="<?php   $row['mba1']; if (empty($row['mba1'])) { echo '---'; } else { echo $row['mba1']; } ?>" class="inputfinales2" placeholder="---"></td>
  ...
  <tr>
    ...
    <td><input type="text" name="zab_b1" placeholder="---"  value="<?php $row['zab_b1']; if (empty($row['zab_b1'])) { echo '---'; } else { echo $row['zab_b1']; }  ?>" class="inputfinales2"></td>
...
<p class="note">Valores despues del relevado de esfuerzos<p-->
	<select class="note" style="border: 0px;">
	  <option disabled selected class="one"> ¡CLIC AQUI! -- ESPECIFICA RELEVADO</option>
      <option>VALORES ANTES DEL RELEVADO DE ESFUERZOS</option>
      <option>VALORES DESPUES DEL RELEVADO DE ESFUERZOS</option>
    </select>
	<br><br>
...
<div class="composicion_q"><table width="981" border="1" class="cuerpo2">
  ...
  <tr class="fields">
    <th>JUNTA</th>
    <th>DESCRIPCION</th>
	<th>UBICACION DE LA TOMA DE DUREZAS <span class="min">(HORARIOS TECNICOS)</span></th>
    ...
    <td rowspan="5"><textarea id="textA2" style="max-width:62px;" rows="4" cols="13" style="overflow-y:hidden" readonly="readonly" class="sinborde" name="descripcion"><?php echo  $row['desc1']; ?></textarea></td>  
    ...
    <td rowspan="5"><textarea id="textA2" style="max-width:62px;" rows="4" cols="10"  style="overflow-y:hidden" readonly="readonly" class="sinborde" name="descripcion"><?php echo  $row['desc2']; ?></textarea></td>  
    ...
    <td rowspan="5"><textarea id="textA2" style="max-width:62px;" rows="4" cols="10" style="overflow-y:hidden" readonly="readonly" class="sinborde" name="descripcion"><?php echo  $row['desc3']; ?></textarea></td>
    ...
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="zacb_15" value="<?php echo  $row['metala_15']; ?>" readonly="readonly"></td>
    ...
    <td rowspan="5"><textarea id="textA2" style="max-width:62px;" rows="4" cols="10" style="overflow-y:hidden" readonly="readonly" class="sinborde" name="descripcion"><?php $row['desc4']; if (empty($row['desc4'])) { echo '---'; } else { echo $row['desc4']; } ?></textarea></td>
...
<table width="981" border="0">
  <tr>
    ...
    <td class="borde" width="316"><textarea style="max-width:800px;" rows="3" cols="130" id="textA" name="proyecto" class="sinborde"></textarea><!--input class="inputfinales2" name="ob2"  size="120" class="sinborde"--></td>
	</tr>
	</table>

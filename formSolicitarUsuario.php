                ...
                <div class="col-12">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">Recuperar usuario</li>
                        </ol>                                       
                    </nav>
                            ...
                            <div class="row align-items-center justify-content-between">
                                ...
                                <h3>Recuperar usuario</h3>
                                    ...
                                    <div class="contact-form-area mb-100">
                                        <form id="validarEmail" action="validaRecuperarUser.php" method="post" role="form" style="display: block;">	

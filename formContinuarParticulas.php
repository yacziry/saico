                    ...
                    <form action="" method="POST" id="tablaResultado">
                        <div class="form-row">
                            ...
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <label>Folio</label>
                                    <input class="form-control" type="text" name="clFolio" value="<?php echo  $row->clFolio; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="deDescripcion" value="<?php echo  $row->deDescripcion; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label>Codigo</label>
                                    <input class="form-control" type="text" name="clCod_Inspeccion" value="<?php echo  $row->clCod_Inspeccion; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                        ...
                        <div class="table-responsive" align="center">
                            <table border="1">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="deMarca1" class="borde" size="10" maxlength="13" value="<?php echo  $row->deMarca1; ?>" disabled></td>
                                    <td><input type="text" name="deModelo1" class="borde" size="10" maxlength="13" value="<?php echo  $row->deModelo1; ?>" disabled></td>
                                    <td><input type="text" name="deLote1" class="borde" size="10" maxlength="13" value="<?php echo  $row->deLote1; ?>" disabled></td>
                                    <td><input type="text" name="deTipo1" class="borde" size="10" maxlength="13" value="<?php echo  $row->deTipo1; ?>" disabled></td>
                                    <td><input type="text" name="deColor1" class="borde" size="10" maxlength="13" value="<?php echo  $row->deColor1; ?>" disabled></td>
                                    <td><input type="text" name="deAplicacion1" class="borde" size="10" maxlength="13" value="<?php echo  $row->deAplicacion1; ?>" disabled></td>
                                </tr>
                                <tr>
                                    <td class="fieldd">CONTRASTANTE</td>
                                    <td><input type="text" name="deMarca2" class="borde" size="10" maxlength="13" value="<?php echo  $row->deMarca2; ?>" disabled></td>
                                    <td><input type="text" name="deModelo2" class="borde" size="10" maxlength="13" value="<?php echo  $row->deModelo2; ?>" disabled></td>
                                    <td><input type="text" name="deLote2" class="borde" size="10" maxlength="13" value="<?php echo  $row->deLote2; ?>" disabled></td>
                                    <td><input type="text" name="deTipo2" class="borde" size="10" maxlength="13" value="NA" disabled></td>
                                    <td><input type="text" name="deColor2" class="borde" size="10" maxlength="13" value="<?php echo  $row->deColor2; ?>" disabled></td>
                                    <td><input type="text" name="deAplicacion2" class="borde" size="10" maxlength="13" value="<?php echo  $row->deAplicacion2; ?>" disabled></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="deMarca3" class="borde" size="10" value="<?php echo  $row->deMarca3; ?>" disabled></td>
                                    <td><input type="text" name="deModelo3" class="borde" size="10" value="<?php echo  $row->deModelo3; ?>" disabled></td>
                                    <td><input type="text" name="deNs" class="borde" size="10" value="<?php echo  $row->deNs; ?>" disabled></td>
                                    <td id="ac" align="center"><input type="radio" name="deCorriente" class="borde" size="10" value="ac" disabled></td>
                                    <td id="dc" align="center"><input type="radio" name="deCorriente" class="borde" size="10" value="dc" disabled></td>
                                 </tr>
                            </table>                               
                        </div><!--responsive-->
                        <br>
                        <div class="form-row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="deTipoMaterial" value="<?php echo  $row->deTipoMaterial; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label>Componente</label>
                                    <input class="form-control" type="text" name="deComponente" value="<?php echo  $row->deComponente; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label>Condicion superficial</label>
                                    <input class="form-control" type="text" name="deCondicion_Sup" value="<?php echo  $row->deCondicion_Sup; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label>Temperatura</label>
                                    <input class="form-control" type="text" name="deTemperatura" value="<?php echo  $row->deTemperatura; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <label>Espesor</label>
                                    <input class="form-control" type="text" name="deEspesor" value="<?php echo  $row->deEspesor; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <label>Tipo de luz</label>
                                    <input class="form-control" type="text" name="deTipo_Luz" value="<?php echo  $row->deTipo_Luz; ?>" disabled>
                                </div>
                            </div>
                            <div class="col-12 col-sm-4">
                                <div class="form-group">
                                    <label>Intensidad</label>
                                    <input class="form-control" type="text" name="deIntensidad" value="<?php echo  $row->deIntensidad; ?>" disabled>
                                </div>
                            </div>                        
                        </div><!--form-row-->
                        <!--div align="center">
                        ...
                        <div class="form-row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Finalizar" class="btn alazea-btn mt-15" id="finalizar" onclick=this.form.action="formRegistroFotPart.php">          
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">

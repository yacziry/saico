                    ...
                    <form action="" method="POST" enctype="multipart/form-data" name="f">
                        <div class="form-row">
                            ...
                            <table class="table table-bordered" borde="1" align="center">
                                ...
                                <tr>
                                    ...
                                    <td><input class="form-control" type="text" name="deMarca" value="SPECTRO"></td>
                                    <td class="fields">MODELO</td>
                                    <td><input class="form-control" type="text" name="deModelo" value="SPECTRO PORT"></td>
                                    <td class="fields">NO.SERIE</td>
                                    <td><input class="form-control" type="text" name="deSerie" value="18010122"></td>
                                </tr>
                            </table>
                            <br>
                            <div class="form-group col-md-12">
                                <div class="form-group">
                                    <input class="form-control" type="text" value="COMPOSICIÓN QUÍMICA  DE LA PIEZA" id="sombreado" disabled>
                                </div>
                            </div>
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <td colspan="7" class="sombreado">PROMEDIO POR ELEMENTO QUÍMICO DE LA COMPOSICIÓN QUIMICA DE LA PIEZA</td>
                                     </tr>
                                </thead>
                                     <tr class="fields">
                                        <td>C</td>
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <textarea class="form-control" rows="5" name="deObservaciones" style="resize:none;" required></textarea>
                            </div>
                            <div class="form-group col-md-12">
                                <div class="form-group">
                                    <input class="form-control" type="text" value="VALORES DE COMPOSICIÓN QUÍMICA" id="sombreado" disabled>
                                </div>
                            </div>
                            <div class="form-group col-md-4">
                                <label for="ex3">Especificación aproximada:</label>
                                <select class="form-control" name="clNorma" id="clNorma" required>
							        <option value="" disabled selected>Elegir una norma</option>
                        ...
                        <div class="form-row">
                            <table class="table table-bordered">
                                <thead>
                                    <tr>
                                        <td colspan="7" class="sombreado">COMPOSICIÓN QUIMICA DE ACUERDO A LA NORMA DE REFERENCIA</td>
                                     </tr>
                                </thead>
                                    <tr class="fields">
                                        <td>C</td>
                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Registrar y continuar" class="btn alazea-btn mt-15" onclick=this.form.action="validarAnalisisQuimico.php">          
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" id="submit" value="Finalizar" class="btn alazea-btn mt-15" onclick=this.form.action="validarAnalisisQuimicoFinalizar.php">
                                </div>
                            </div>
                        </div>
                    </form>

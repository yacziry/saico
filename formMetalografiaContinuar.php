                        ...
                        <div class="form-row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <?php
                                        ...
                                        $c = new Cliente();
                                        $cl = $c->seleccionado($row->cacliente_clCliente);
                                        foreach ($cl as $r){
                            ...
                            <div class="table-responsive" align="center">
                                ...
                                <div class="alert alert-warning alert-dismissable">
                                    ...
                                    <strong>&iexcl;Cuidado!</strong> Tama&ntilde;o Maximo 350Kb por foto".
                                </div>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <!--textarea id="byetext" class="form-control" name="deAprobacion" style="max-width:500px; resize:none;" rows="3">Asesor�a e Inspecci�n en Construcci�n Costa Fuera, S.C</textarea disabled-->
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    ...
                                    <!--textarea id="byetext" class="form-control" name="empresa1" style="max-width:500px; resize:none;" rows="3">Asesor�a e Inspecci�n en Construcci�n Costa Fuera, S.C</textarea-->
                                </div>                                    
                            </div>
                            <br>
                            <div class="col-12 col-sm-6">

                ...
                <div class="col-12">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        <div class="form-row">
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Actualizar" class="btn alazea-btn mt-15" onclick=this.form.action="validarActualizarMetalografia.php">
                                </div>
                            </div>
                            <br>
                        </div>
...
<script src="js/carga_imagen.js"></script>
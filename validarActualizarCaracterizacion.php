    ...
    if(empty($_POST['clContrato'])){
        ...
        $arrayCaracterizacion=array('clContrato'=>$_POST['clContrato'],'deProyecto'=>$_POST['deProyecto'],'clOrdenTrabajo'=>$_POST['clOrdenTrabajo'],
            ...
            //instancia para metodo update
                ...
                //enviar parametros
                $c->modificar($reporteS, $arrayCaracterizacion);
                //obtener ultimo id
                $lastId = $c->buscarID($clNumReporte);
                    ...
                    if(move_uploaded_file($_FILES['deImagen']['tmp_name'], $ruta.$_FILES['deImagen']['name'])){
                        ...
                        $arreglo = array('id'=>$lastId,'clNumReporte'=>$clNumReporte,'deImagen'=>$fecha.$extension, 'deObservaciones'=>$_POST['deObservaciones']);
                    ...
                    if(move_uploaded_file($_FILES['deImagen2']['tmp_name'], $ruta.$_FILES['deImagen2']['name'])){
		                ...
		                $arreglo = array('id'=>$lastId,'clNumReporte'=>$clNumReporte,'deImagen2'=>$fecha."02".$extension2, 'deObservaciones'=>$_POST['deObservaciones']);
		                $imagen->modificar($clNumReporte, $arreglo);	                                                           
                    }
                    if(move_uploaded_file($_FILES['deImagen3']['tmp_name'], $ruta.$_FILES['deImagen3']['name'])){
		                ...
		                $arreglo = array('id'=>$lastId,'clNumReporte'=>$clNumReporte,'deImagen3'=>$fecha."03".$extension3, 'deObservaciones'=>$_POST['deObservaciones']);
		                $imagen->modificar($clNumReporte, $arreglo);	                                                           
                    }
                    else{
		                $arreglo = array('id'=>$lastId,'clNumReporte'=>$clNumReporte,'deObservaciones'=>$_POST['deObservaciones']);
		                $imagen->modificar($clNumReporte, $arreglo);           
					}

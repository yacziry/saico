...
<?php
    require 'particulasDAO.php';
        $p = new Particulas();
		//$forReportes = $p->buscarReporte("10/04");
        $forReportes = $p->buscarReporte($reporteS);
		...
		<div class="cuerpo">
			<table width="981" border="1" height="70">
				...
				<tr align="center">
					...
					<td><input type="text" class="sinborde" size="12" value="<?php echo  $row->deMarca2; ?>" readonly="readonly"></td>
			...
			<table width="800" border="1" height="70">
				<tr>
				 ...
				 <tr>
					...
					<td colspan="2" align="center"><input type="text" style="text-align: center" class="sinborde" size="12" value="<?php echo  $row->deCorriente; ?>" readonly="readonly"></td>
				 </tr>
			</table>
		</div>
		<br>
			...
			<div class="cuerpo">
				<table width="981" border="0">
					<tr>
						...
						<td width="210"><input type="text" class="sinborde" size="32" value="<?php echo  $row->deEspesor; ?>" readonly="readonly"></td>
						<td width="95">TIPO DE LUZ:</td>
						<td width="144"><input type="text" class="sinborde" size="32" value="<?php echo  $row->deTipo_Luz; ?>" readonly="readonly"></td>
						<td width="80">INTENSIDAD:</td>
						<td width="156"><input type="text" class="sinborde" size="34" value="<?php echo  $row->deIntensidad; ?>" readonly="readonly"></td>
					</tr>
				</table>
			</div>
		</div>
					...
					<tr>
						<td>
							<table width="970" border="0">
								...
								<tr>
									<td align="center"><input size="50" class="sinborde" value="<?php echo  $row->deDescripcion1; ?>" readonly="readonly"></td>
									<td align="center"><input size="50" class="sinborde" value="<?php echo  $row->deDescripcion2; ?>" readonly="readonly"></td>
								</tr>
								<tr>
									<td width="470" height="300">
								...
								<tr>
									<td align="center"><input size="50" class="sinborde" value="<?php echo  $row->deDescripcion3; ?>" readonly="readonly"></td>
									<td align="center"><input size="50" class="sinborde" value="<?php echo  $row->deDescripcion4; ?>" readonly="readonly"></td>
								</tr>
							</table>
						</td>
					</tr>

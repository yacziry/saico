                        ...
                        <div class="form-row">
                            ...
                            <div class="col-12 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="deProyecto" value="<?php echo  $row->clContrato; ?>" required>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label for="ex3">Orden de trabajo</label>
                                    <input class="form-control" type="text" name="clOrdenTrabajo" value="<?php echo  $row->clContrato; ?>" required>
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <label for="ex3">Folio</label>
                                    <input class="form-control" type="text" name="clFolio" value="<?php echo  $row->clContrato; ?>" required>
                                </div>
                            </div>
                            ...
                            <div class="table-responsive" align="center">
                                ...
                                <table borde="1" class="table table-bordered">
                                    ...
                                    <tr>
                                       <td><input class="form-control" type="text" name="clPromedio" size="10"></td>
                                       <td><input class="form-control" type="text" name="deNormaReferencia"></td>
                                    </tr>
                                </table>
                            </div>
                            <br>

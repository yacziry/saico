...
<head>
  ...
  <link href="/AICO/img/IC.png" rel="icon">
	...
	$query ="SELECT idRelevado1 FROM relevado_1 WHERE  claveTecnico = '$tec' ORDER BY idRelevado1 DESC LIMIT 1";
	$execute = mysqli_query($conn, $query);
	//Compruebo si hay algún resultado
	if($row =  mysqli_fetch_array($execute)){
		//Guardo los datos de la BD en las variables de php
		$id =  utf8_encode($row["idRelevado1"]);
		}
	?>
...
<div class="encabezado"><table width="981" height="80" border="1">
  <tr>
    ...
    <td id="centrado" width="200" rowspan="3"onclick="location.href='index2.php'"><span><img src="/AICO/img/icon.png" alt="sample"></span></td>
  </tr>
  <tr>
...
<?php
require 'conexionsqli.php';
$query ="SELECT * FROM relevado_1 r1, relevado_2 r2 WHERE r1.idRelevado1 = r2.idRelevado1 ORDER BY id DESC LIMIT 1";
$execute = mysqli_query($conn, $query);
//Compruebo si hay algún resultado
if($row =  mysqli_fetch_array($execute)){
	//Guardo los datos de la BD en las variables de php
	$cl =  utf8_encode($row["cliente"]);
	}
?>
...
<div class="cuerpo"><table width="981" border="0">
  <tr>
    ...
    <td width="340" colspan="2"><input type="text" name="contrato" value="<?php echo  $row['contrato']; ?>" class="sinborde" size="42"></td>
  </tr>
  </table>
  </div>
  <br>
...
<br>
<form action="guarda_relevado2.php" method="POST">
<div class="cuerpo"><table width="981" border="0">
  <tr>
...
<div class="composicion_q"><table width="981" border="1" class="table table-bordered; fixed">
  ...
  <tr>
    <td width="350" class="fields">METAL BASE (A,A1)</td>															<!--If "vacio = antes :p"-->
    <td width="144"><input type="text" name="mba1" value="<?php   $row['mba1']; if (empty($row['mba1'])) { echo round($row['p_mba1'])." , ".round($row['p_metalba1']); } else { echo $row['mba1']; } ?>" class="inputfinales2" placeholder="---"></td>
    <td width="70" class="fields">MARCA</td>
    <td width="174"><input type="text" name="marca" value="<?php echo  $row['marca']; ?>" class="inputfinales2" placeholder="--"></td>
  </tr>
  <tr>
    <td class="fields">ZONA AFECTADA POR EL CALOR ZAC (B,B1)</td>
    <td><input type="text" name="zab_b1" placeholder="---"  value="<?php $row['zab_b1']; if (empty($row['zab_b1'])) { echo round($row['p_zacb1'])." , ".round($row['p_zacb1_1']); } else { echo $row['zab_b1']; }  ?>" class="inputfinales2"></td>
    <td class="fields">MODELO</td>
    <td><input type="text" name="modelo" placeholder="--" value="<?php echo  $row['modelo']; ?>" class="inputfinales2" ></td>
  </tr>
  <tr>
    <td class="fields">SOLDADURA ( C )</td>
    <td><input type="text" name="soldadura_c" value="<?php $row['soldadura_c']; if (empty($row['soldadura_c'])) { echo round($row['p_soldadurac1']); } else { echo $row['soldadura_c']; }?>" placeholder="---" class="inputfinales2"></td>
    <td class="fields">NO.SERIE</td>
    <td><input type="text" name="n_serie" placeholder="--" value="<?php echo  $row['n_serie']; ?>" class="inputfinales2"></td>
  </tr>
</table>
</div>
<br>
...
<p class="note">Valores despues del relevado de esfuerzos<p-->
	<input id="negrita" type="text" name="" value="<?php echo  $row['comboRelevado']; ?>" size="46" class="sinborde">
	<br><br>
<div class="table-responsive">
<div class="composicion_q"><table width="981"  border="1" class="cuerpo2">
  <thead>
	<tr class="fields">
    <td colspan="3">DATOS DE LA UNI&Oacute;N DE LA TOMA DE DUREZA</td>
    <td colspan="5">VALORES DE DUREZA <input class="escala" size="9" value="<?php echo  $row['escala']; ?>" readonly="readonly"></td>
    <td rowspan="2">OBSERVACIONES</td>
  </tr>
  <tr class="fields">
    <th>JUNTA</th>
    <th>DESCRIPCION</th>
	<th>UBICACION DE LA<BR> TOMA DE DUREZAS<BR><span class="min">(HORARIOS TECNICOS)</span></th>
	...
	<tbody>
	<?php $textfirma_1=utf8_encode($_POST['textfirma_1']); ?>
	<?php $textfirma_2=utf8_encode($_POST['textfirma_2']); ?>
	<?php $textfirma_3=utf8_encode($_POST['textfirma_3']); ?>
	<tr align="center">
	<td rowspan="5"><input class="inputfinales2" size="6" name="j1" value="<?php echo  $row['j1']; ?>"  readonly="readonly" ></td>
    <td rowspan="5"><textarea id="textA2" style="max-width:120px; overflow:hidden"  cols="15" style="overflow-y:hidden" readonly="readonly" class="sinborde" name="descripcion"><?php echo  $row['desc1']; ?></textarea></td>  
    <td rowspan="5"><input class="inputfinales2" size="7" name="horarios1"value="<?php echo  $row['horarios1']; ?>"  readonly="readonly"></td>
    ...
    <tr>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="metala_5" value="<?php echo  $row['metala_5']; ?>"  readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="zacb_5" value="<?php echo  $row['zacb_5']; ?>" readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="soldadurac_5" value="<?php echo  $row['soldadurac_5']; ?>" readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="zacb1_5" value="<?php echo  $row['zacb1_5']; ?>" readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2"size="10" name="metalba1_5" value="<?php echo  $row['metalba1_5']; ?>"  readonly="readonly"></td>
	</tr>
    <tr>
	<td rowspan="5"><input size="6" class="inputfinales2" name="j2" value="<?php echo  $row['j2']; ?>" readonly="readonly"></td>
    <td rowspan="5"><textarea id="textA2" style="max-width:120px; overflow:hidden"  cols="15"  style="overflow-y:hidden" readonly="readonly" class="sinborde" name="descripcion"><?php echo  $row['desc2']; ?></textarea></td>  
    <td rowspan="5"><input class="inputfinales2" size="7" name="horarios2" value="<?php echo  $row['horarios2']; ?>"  readonly="readonly"></td>
    ...
    <tr>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="metala_10" value="<?php echo  $row['metala_10']; ?>" class="sinborde" readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="zacb_10" value="<?php echo  $row['zacb_10']; ?>" class="sinborde" readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="soldadurac_10" value="<?php echo  $row['soldadurac_10']; ?>"  readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="zacb1_10" value="<?php echo  $row['zacb1_10']; ?>" class="sinborde" readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="metalba1_10" value="<?php echo  $row['metalba1_10']; ?>"  readonly="readonly"></td>
	</tr>	
    <tr>
	<td rowspan="5"><input class="inputfinales2" size="6" name="j3" value="<?php echo  $row['j3']; ?>"  readonly="readonly"></td>
    <td rowspan="5"><textarea id="textA2" style="max-width:120px; overflow:hidden"  cols="15" readonly="readonly" class="sinborde" name="descripcion"><?php echo  $row['desc3']; ?></textarea></td>
    <td rowspan="5"><input class="inputfinales2" size="7" name="horarios3" value="<?php echo  $row['horarios3']; ?>"  readonly="readonly"></td>
    ...
    <tr>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="metala_15" value="<?php echo  $row['metala_15']; ?>"  readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="zacb_15" value="<?php echo  $row['zacb_15']; ?>" readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="soldadurac_15" value="<?php echo  $row['soldadurac_15']; ?>" readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="zacb1_15" value="<?php echo  $row['zacb1_15']; ?>" readonly="readonly"></td>
    <td style="border-bottom:2px solid #000000"><input class="inputfinales2" size="10" name="metalba1_15" value="<?php echo  $row['metalba1_15']; ?>"  readonly="readonly"></td>
	</tr>	
    <tr>
	<td rowspan="5"><input size="6" class="inputfinales2" name="j4" value="<?php $row['j4']; if (empty($row['j4'])) { echo '---'; } else { echo $row['j4']; } ?>"  readonly="readonly"></td>
    <td rowspan="5"><textarea id="textA2" style="max-width:120px; overflow:hidden"  cols="15" readonly="readonly" class="sinborde" name="descripcion"><?php $row['desc4']; if (empty($row['desc4'])) { echo '---'; } else { echo $row['desc4']; } ?></textarea></td>
    <td rowspan="5"><input size="7" class="inputfinales2"name="horarios4" value="<?php $row['horarios4']; if (empty($row['horarios4'])) { echo '---'; } else { echo $row['horarios4']; } ?>"  readonly="readonly"></td>
	...
	<td class="inputfinalestd"><input class="inputfinales3" size="10"  name="p_mba1" value="<?php echo round($row['p_mba1']) ?>" class="sinborde"></td>
    <td class="inputfinalestd"><input class="inputfinales3" size="10"  name="p_zacb1" value="<?php echo round($row['p_zacb1']) ?>"class="sinborde"></td>
    <td class="inputfinalestd"><input class="inputfinales3" size="10"  name="p_soldadurac1" value="<?php echo round($row['p_soldadurac1']) ?>" class="sinborde"></td>
    <td class="inputfinalestd"><input class="inputfinales3" size="10"  name="p_zacb1_1" value="<?php echo round($row['p_zacb1_1']) ?>"class="sinborde" ></td>
    <td class="inputfinalestd"><input class="inputfinales3" size="10"  name="p_metalba1" value="<?php echo round($row['p_metalba1']) ?>"class="sinborde" ></td>
	</tr>	
	</tbody>
</table>
</form>
...
<table width="981" border="0">
  <tr>
    ...
    <td class="borde" width="316"><textarea style="max-width:800px; overflow:hidden" rows="3" cols="130" id="textA" name="proyecto" class="sinborde"><?php echo  $row['comentario']; ?></textarea><!--input class="inputfinales2" name="ob2"  size="120" class="sinborde"--></td>
	</tr>
	</table>

...
<?php
    ...
    require 'clientesDAO.php';
        $c = new Cliente();
        $cliente = $c->buscar($row->clCliente);
		foreach ($forReportes as $row){
?>
    ...
    <body align="center">
            ...
            <div class="cuerpo">
                <table width="981" border="0">
                    <tr>
                        ...
                        <td width="210"><input type="text" value="<?php echo  $row->deAccesorio; ?>" class="sinborde" size="33"></td>
                        <td width="134" align="center">TUBERIA:</td>
                        <td width="144"><input type="radio" value="<?php echo  $row->deTubEstruc; ?>" class="sinborde"></td>
                        <td width="70">ESTRUCTURAL:</td>
                        <td width="156"><input type="radio" value="<?php echo  $row->deTubEstruc; ?>" class="sinborde"></td>
                    </tr>
                </table>
            </div>
            <br>
        ...
        <div class="m_table">
            <table width="981" border="1">
                ...
                <tr>
                    <td width="75"><label class="texto"><?php echo  $row->numLija1; ?></label></td>
                    <td width="75"><label class="texto"><?php echo  $row->numLija2; ?></label></td>
                    <td width="70"><label class="texto"><?php echo  $row->numLija3; ?></label></td>
                    ...
                    <td rowspan="2"><label class="texto"><?php echo  $row->deEspecificacion; ?></td>
                </tr>
                <tr>
                    <td><label class="texto"><?php echo  $row->numLija4; ?></label></td>
                    <td><label class="texto"><?php echo  $row->numLija5; ?></label></td>
                    <td><label class="texto"><?php echo  $row->numLija6; ?></label></td>

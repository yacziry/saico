    ...
    <header>
        <div class="profileLogo">
            ...
            <p class="logoPlaceholder">
                <span><img src="img/logop.jpg" alt="sample"></span>
                <h3 align="center">INFORME CON LIQUIDOS</h3>
                <hr>
        </div>
    </header>
    <form action="guarda_juntasLiq.php" method="POST">
        <div align="center">

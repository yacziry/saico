                ...
                <div class="col-12">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" name="f">
                        <div class="form-row">
                                ...
                                <div style="width:40%; float:left;">
                                    <table width="400" border="1">
                                        ...
                                        <tr>
                                            ...
                                            <td><input class="form-control" type="text" name="vlPromedioC"></td>
                                            <td id="vlPromedioC"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">Mn</td>
                                            <td><input class="form-control" type="text" name="vlPromedioMn"></td>
                                            <td id="vlPromedioMn"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">P</td>
                                            <td><input class="form-control" type="text" name="vlPromedioP"></td>
                                            <td id="vlPromedioP"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">S</td>
                                            <td><input class="form-control" type="text" name="vlPromedioS"></td>
                                            <td id="vlPromedioS"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">Si</td>
                                            <td><input class="form-control" type="text" name="vlPromedioSi"></td>
                                            <td id="vlPromedioSi"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">Cu</td>
                                            <td><input class="form-control" type="text" name="vlPromedioCu"></td>
                                            <td id="vlPromedioCu"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">Ni</td>
                                            <td><input class="form-control" type="text" name="vlPromedioNi"></td>
                                            <td id="vlPromedioNi"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">Cr</td>
                                            <td><input class="form-control" type="text" name="vlPromedioCr"></td>
                                            <td id="vlPromedioCr"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">Mo</td>
                                            <td><input class="form-control" type="text" name="vlPromedioMo"></td>
                                            <td id="vlPromedioMo"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">V</td>
                                            <td><input class="form-control" type="text" name="vlPromedioV"></td>
                                            <td id="vlPromedioV"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">Nb</td>
                                            <td><input class="form-control" type="text" name="vlPromedioNb"></td>
                                            <td id="vlPromedioNb"></td>
                                        </tr>
                                        <tr>
                                            <td class="fields">N</td>
                                            <td><input class="form-control" type="text" name="vlPromedioN"></td>
                            ...
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Finalizar" class="btn alazea-btn mt-15" onclick=this.form.action="validarCaracterizacionFinalizar.php">
                                </div>
                            </div>
                        </div>
                    </form>

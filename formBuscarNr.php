...
<div id="ocultar">
    ...
    <body>
                                ...
                                <div class="classynav">
                                    <ul>
                                        ...
                                        <li><a href="#">Consulta de reportes</a>
                                            <ul class="dropdown">
                                                <li><a href="#">Numero de reporte</a></li>
        ...
        <div class="breadcrumb-area">
                ...
                <div class="row">
                    <div class="col-12">
					    ...
					    <div align="center">
						    ...
						    <h3>Elegir el n&uacute;mero de reporte y la tecnica</h3>
						    <br>										
						    <form>								
							    ...
							    <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <input type="text" class="form-control"  name="clNumReporte" id="clNumReporte" placeholder="Digite el numero de reporte" required>
                                    </div>
                                </div>
            ...
            <div id="sinRegistros" align="center"><b>"No hay registros"</b></div>
		    <br>
        <!-- ##### Breadcrumb Area End ##### -->

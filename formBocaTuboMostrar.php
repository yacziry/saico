...
$forResultados = $bdt->buscarReporteResultado($reporteS);
	...
	<body>
		<div class="mt-5">
			...
			<div id="center" align="center">
					...
					<table style="width: 1312px; min-width: 700px" border="1">
						<thead>
							<tr style="height: 33px;">
								...
								<th style="width: 389px; height: 33px; text-align: center; background-color: antiquewhite;" colspan="1">ACOPLANTE:</th>
				...
				<div style="overflow-x: auto; max-width: 1312px; min-width: 440px;" class="cuerpo" align="center">
					<table class="table table-condensed table-bordered">
						...
						<tbody id="tablaReportes">
							...
							$i = 0;
							?>
							<?php foreach ($forResultados as $tabla) : ?>
								<tr>
									<td style='height: 26px;' class='id'><input name='id[]' value="<?php echo $tabla->clID; ?>" style='width: 40px; text-align: center;' required></td>
									<td style='height: 26px;' class='elemento'><input name='elemento[]' value="<?php echo $tabla->deElemento; ?>" style='width: 80px; text-align: center;' required></td>
									<td style='height: 26px;' class='diametro'><input name='diametro[]' value="<?php echo $tabla->deDiametro; ?>" style='width: 80px; text-align: center;' required></td>
									<td style='height: 26px;' class='noDeAceptacion'><input name='noDeAceptacion[]' value="<?php echo $tabla->clAceptacion; ?>" style='width: 105px; text-align: center;' required></td>
									<td style='height: 26px;' class='noDeSerie'><input name='noDeSerie[]' value="<?php echo $tabla->clSerie; ?>" style='width: 80px; text-align: center;' required></td>
									<td style='height: 26px;' class='noDeColada'><input name='noDeColada[]' value="<?php echo $tabla->clColada; ?>" style='width: 80px; text-align: center;' required></td>
									<td style='height: 26px;' class='espesorNominal'><input name='espesorNominal[]' value="<?php echo $tabla->deEspesorNominal; ?>" style='width: 110px; text-align: center;' required></td>
									<td style='height: 26px;' class='indicacion'><input name='indicacion[]' value="<?php echo $tabla->clIndicacion; ?>" style='width: 80px; text-align: center;' required></td>
									<td style='height: 26px;' class='largo'><input name='largo[]' value="<?php echo $tabla->deLargo; ?>" style='width: 60px; text-align: center;' required></td>
									<td style='height: 26px;' class='ancho'><input name='ancho[]' value="<?php echo $tabla->deAncho; ?>" style='width: 60px; text-align: center;' required></td>
									<td style='height: 26px;' class='desdeX'><input name='desdeX[]' value="<?php echo $tabla->deX; ?>" style='width: 60px; text-align: center;' required></td>
									<td style='height: 26px;' class='desdeY'><input name='desdeY[]' value="<?php echo $tabla->deY; ?>" style='width: 60px; text-align: center;' required></td>
									<td style='height: 26px;' class='espesorMax'><input name='espesorMax[]' value="<?php echo $tabla->deEspesorMaximo; ?>" style='width: 80px; text-align: center;' required></td>
									<td style='height: 26px;' class='espesorMin'><input name='espesorMin[]' value="<?php echo $tabla->deEspesorMinimo; ?>" style='width: 80px; text-align: center;' required></td>
									<td style='height: 26px;' class='areaBarrido'><input name='areaBarrido[]' value="<?php echo $tabla->deBarrido; ?>" style='width: 80px; text-align: center;' required></td>
									<td style='height: 26px;' class='resultado'><input name='resultado[]' value="<?php echo $tabla->deResultado; ?>" style='width: 80px; text-align: center;' required></td>
								</tr>
								<!-- <?php
										$i++;
										?>

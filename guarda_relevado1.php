...
// Desactivar toda las notificaciónes del PHP xd
	...
	$tec = $_SESSION["tecnico"];//pasarla a una variable
	  ...
	  //datos
		  ...
		  $formato='FOR-PIMP-04';
		  $promedio=$_POST['promediar'];	  

		  $sentencia = "insert into relevado_1 values (NULL, :cliente, :contrato, :proyecto, :ot, :folio, :n_reporte, :fecha, :lugar, :soldadura, :formato, :promedio, :tec)";
		  try{ 	  
			  ...
			  if($sql->rowCount()==1){
				  ...
				  $foranea = $conexion->lastInsertId();
				  $error = $sql->errorInfo();
				  echo $error[2];
					//Asignacion promedios
				  $promediar=($_POST['promediar']);

				  $p_mba1= ($metala_1=$_POST['metala_1'] +$metala_2=$_POST['metala_2'] +$metala_3=$_POST['metala_3'] +$metala_4=$_POST['metala_4'] +$metala_5=$_POST['metala_5']+$metala_6=$_POST['metala_6'] +$metala_7=$_POST['metala_7'] +$metala_8=$_POST['metala_8'] +$metala_9=$_POST['metala_9'] +$metala_10=$_POST['metala_10']+
				  $metala_11=$_POST['metala_11']+$metala_12=$_POST['metala_12']+$metala_13=$_POST['metala_13']+$metala_14=$_POST['metala_14']+$metala_15=$_POST['metala_15']+$metala_16=$_POST['metala_16']+$metala_17=$_POST['metala_17']+$metala_18=$_POST['metala_18']+$metala_19=$_POST['metala_19']+$metala_20=$_POST['metala_20'])/$promediar;

				  $p_zacb1= ($zacb_1=$_POST['zacb_1'] +$zacb_2= $_POST['zacb_2']+$zacb_3=$_POST['zacb_3']+$zacb_4=$_POST['zacb_4']+$zacb_5=$_POST['zacb_5']+$zacb_6=$_POST['zacb_6']+$zacb_7=$_POST['zacb_7']+$zacb_8=$_POST['zacb_8'] +$zacb_9=$_POST['zacb_9'] +$zacb_10=$_POST['zacb_10'] +$zacb_11=$_POST['zacb_11'] +$zacb_12=$_POST['zacb_12'] +$zacb_13=$_POST['zacb_13'] +$zacb_14=$_POST['zacb_14'] +$zacb_15=$_POST['zacb_15']+
				  +$zacb_16=$_POST['zacb_16']+$zacb_17=$_POST['zacb_17'] +$zacb_18=$_POST['zacb_18'] +$zacb_19=$_POST['zacb_19'] +$zacb_20=$_POST['zacb_20'])/$promediar;

				  $p_soldadurac1= ($soldadurac_1=$_POST['soldadurac_1']+$soldadurac_2=$_POST['soldadurac_2']+$soldadurac_3=$_POST['soldadurac_3']+$soldadurac_4=$_POST['soldadurac_4']+$soldadurac_5=$_POST['soldadurac_5']+$soldadurac_6=$_POST['soldadurac_6']+$soldadurac_7=$_POST['soldadurac_7']+$soldadurac_8=$_POST['soldadurac_8']+$soldadurac_9=$_POST['soldadurac_9']+$soldadurac_10=$_POST['soldadurac_10']+
				  $soldadurac_11=$_POST['soldadurac_11']+$soldadurac_12=$_POST['soldadurac_12']+$soldadurac_13=$_POST['soldadurac_13']+$soldadurac_14=$_POST['soldadurac_14'] +$soldadurac_15=$_POST['soldadurac_15']+$soldadurac_16=$_POST['soldadurac_16']+$soldadurac_17=$_POST['soldadurac_17']+$soldadurac_18=$_POST['soldadurac_18']+$soldadurac_19=$_POST['soldadurac_19']+$soldadurac_20=$_POST['soldadurac_20'])/$promediar;
	
				  $p_zacb1_1= ($zacb1_1=$_POST['zacb1_1']+$zacb1_2=$_POST['zacb1_2']+$zacb1_3=$_POST['zacb1_3']+$zacb1_4=$_POST['zacb1_4']+$zacb1_5=$_POST['zacb1_5']+$zacb1_6=$_POST['zacb1_6']+$zacb1_7=$_POST['zacb1_7']+$zacb1_8=$_POST['zacb1_8']+$zacb1_9=$_POST['zacb1_9']+$zacb1_10=$_POST['zacb1_10']+$zacb1_11=$_POST['zacb1_11']+$zacb1_12=$_POST['zacb1_12']+$zacb1_13=$_POST['zacb1_13']+$zacb1_14=$_POST['zacb1_14']+$zacb1_15=$_POST['zacb1_15']+
				  $zacb1_16=$_POST['zacb1_16']+$zacb1_17=$_POST['zacb1_17']+$zacb1_18=$_POST['zacb1_18']+$zacb1_19=$_POST['zacb1_19']+$zacb1_20=$_POST['zacb1_20'])/$promediar;

				  $p_metalba1= ($metalba1_1=$_POST['metalba1_1']+$metalba1_2=$_POST['metalba1_2']+$metalba1_3=$_POST['metalba1_3']+$metalba1_4=$_POST['metalba1_4']+$metalba1_5=$_POST['metalba1_5']+$metalba1_6=$_POST['metalba1_6']+$metalba1_7=$_POST['metalba1_7']+$metalba1_8=$_POST['metalba1_8']+$metalba1_9=$_POST['metalba1_9']+$metalba1_10=$_POST['metalba1_10']+
				  $metalba1_11=$_POST['metalba1_11']+$metalba1_12=$_POST['metalba1_12']+$metalba1_13=$_POST['metalba1_13']+$metalba1_14=$_POST['metalba1_14']+$metalba1_15=$_POST['metalba1_15']+$metalba1_16=$_POST['metalba1_16']+$metalba1_17=$_POST['metalba1_17']+$metalba1_18=$_POST['metalba1_18']+$metalba1_19=$_POST['metalba1_19']+$metalba1_20=$_POST['metalba1_20'])/$promediar;
	...
	header("location:for_relevado.php")	  
	?>

                ...
                <div class="col-12">
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="table-responsive" align="center">
                            <table border="1">
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="deTiempo1" class="borde" size="10" maxlength="13" required></td>
                                    <td>
                                        <select class="form-control" name="deAplicacion1">
                                            <option disabled selected>Seleccionar</option>
                                            <option>Atomizador</option>
                                            <option>Brocha</option>
                                            <option>Inmersion</option>
                                        </select>
                                    </td>
                                    </td>
                                    <td>
                                        <select class="form-control" name="deTipo1">
                                            <option disabled selected>Seleccionar</option>
                                            <option>Flourescente</option>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <select class="form-control" name="deTipo2">
                                            <option disabled selected>Seleccionar</option>
                                            <option>Agua</option>
                                ...
                                <tr>
                                    ...
                                    <td><input type="text" name="deMarca3" class="borde" size="10" maxlength="13" required></td>
                                    <td><input type="text" name="deModelo3" class="borde" size="10" maxlength="13" required></td>
                                    <td><input type="text" name="deLote3" class="borde" size="10" maxlength="13" required></td>
                                    <td><input type="text" name="deTiempo3" class="borde" size="10" maxlength="13" required></td>
                                    <td><input type="text" name="deAplicacion3" class="borde" size="10" maxlength="13" required></td>
                                    <td>
                                        <select class="form-control" name="deTipo3">
                                            <option disabled selected>Seleccionar</option>
                                            <option>Acuoso</option>
                                            <option>No acuoso</option>
                                            <option>Seco</option>
                                        </select>
                                    </td>
                                </tr>
                        ...
                        <div class="form-row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Finalizar" class="btn alazea-btn mt-15" onclick=this.form.action="validarLiqFinalizar.php">          
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Registrar mas juntas" class="btn alazea-btn mt-15" onclick=this.form.action="validarPartJuntas.php">
                                </div>
                            </div>
                        </div>
                        <br>

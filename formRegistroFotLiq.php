...
<body>
    ...
    <div class="breadcrumb-area">
        ...
        <div class="top-breadcrumb-area bg-img bg-overlay d-flex align-items-center justify-content-center" style="background-image: url(img/bg-img/4.jpg);">
            <h2>REPORTE DE L&Iacute;QUIDOS PENETRANTES</h2>
        </div>
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    <form action="" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Finalizar" class="btn alazea-btn mt-15" onclick=this.form.action="validarRegistroFotLiq.php">          
                                </div>
                            </div>
                            <div class="col-12 col-sm-6">
                                <div class="form-group">
                                    <input type="submit" value="Agregar otro registro" class="btn alazea-btn mt-15" onclick=this.form.action="validarRegistroFotLiq2.php">
                                </div>
                            </div>
                        </div>
                        <br>

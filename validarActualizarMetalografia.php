    ...
    if(empty($_POST['clContrato'])){
        ...
        $arrayMetalografia=array('clContrato'=>$_POST['clContrato'],'deProyecto'=>$_POST['deProyecto'],'clOrdenTrabajo'=>$_POST['clOrdenTrabajo'],
            ...
            $_SESSION["reporteS"] = $reporteS;
                ...
                $m->modificar($reporteS, $arrayMetalografia);
                //obtener ultimo id
                ...
                $clNumReporte = $_POST['clNumReporte'];
	                ...
	                if(move_uploaded_file($_FILES['deImagen']['tmp_name'], $ruta.$_FILES['deImagen']['name'])){
                        ...
                        $arreglo = array('id'=>$lastId,'clNumReporte'=>$clNumReporte,'deImagen'=>$fecha.$extension, 'deObservaciones'=>$_POST['deObservaciones'],'deGrano'=>$_POST['deGrano']);
                    ...
                    if(move_uploaded_file($_FILES['deImagen2']['tmp_name'], $ruta.$_FILES['deImagen2']['name'])){
		                ...
		                $arreglo = array('id'=>$lastId,'clNumReporte'=>$clNumReporte,'deImagen2'=>$fecha."02".$extension2, 'deObservaciones'=>$_POST['deObservaciones'],'deGrano'=>$_POST['deGrano']);
		                $imagen->modificar($clNumReporte, $arreglo);	                                                           
                    }
                    else{
